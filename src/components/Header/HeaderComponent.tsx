...
export const HeaderComponent: React.FC<{HeaderInfo: HeaderComponentProps}> = ({ HeaderInfo }) => {
  ...
  return (
    <div className="w-full relative lg:h-[1181px] h-[808px]" >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white z-10 w-full px-4">
        <h4 className="font-cofo leading-[22.68px] font-semibold underline text-sm decoration-transparent xl:mb-4 w-full">
