...
export const SwiperSlider = ({
  ...
  return (
    <div className="relative 2xl:ms-[3.02vw]  xl:ms-[2vw] ms-[1.41vw] lg:ms-[30px] md:ms-[20px]  mt-[30px]  mr-[calc(-1*((100vw-87.7%)/2))] md:w-[calc(100%+((100vw-87.7%)/2))] overflow-x-hidden">
      ...
      <button
        className="w-[35px] h-[35px] lg:w-[48px] lg:h-[48px] 2xl:w-[60px] 2xl:h-[60px] xl:w-[54px] xl:h-[54px]
          items-center justify-center xl:right-[13.5vw]
                 right-5 2xl:right-[12.2vw] z-10 hover:text-white text-[#8C331B] bg-white hover:bg-[#8C331B] 
                 absolute top-1/2 
