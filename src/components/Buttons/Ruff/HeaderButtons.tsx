...
export const HeaderButtons = () => {
  ...
  return (
   ...
   hover:cursor-pointer  md:py-[10.5px] px-[70px] py-[11px] rounded-full text-md hover:text-[#8C331B] hover:bg-white"
      ...
      <button className="font-cofo-medium uppercase px-[10px] py-[10px] border border-[#FFFFFF] text-[#FFFFFF] lg:w-[184px] hover:cursor-pointer md:py-[10.5px] rounded-4xl  md:text-[13px] lg:text-[14px] text-[12px] ">
        {t("buttons.bookTable")}
      </button>
    </div>
  );
