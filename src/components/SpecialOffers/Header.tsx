  ...
  return (
    <div className="flex items-center justify-center bg-[#252526] 2xl:pt-[117px] xl:pt-[102px] lg:pt-[93px] md:pt-[80px] pt-[73px]   px-[38px_40px]">
      <div className="grid w-full  lg:grid-cols-[33.31%_33.43%_33.26%] grid-cols-1 text-[#EDE8E5] text-center lg:text-start max-w-[1720px]">
        <div className=" border-x  lg:border-e-0 border-[#515151] flex flex-col items-center lg:items-start text-center lg:text-left py-[53px_49px] xl:py-[53px_80px] lg:py-[53px_79px] px-6 lg:pt-[96px] lg:pl-[31px] ">
          <h1
          ...
          <p
            className="relative uppercase  text-[12px] sm:text-[14px] md:text-[16px] lg:text-[16px] xl:text-[18px] leading-tight 2xl:pt-[51px] xl:pt-[40px] lg:pt-[34px] pt-[20px] 2xl:w-[80%] md:w-[65%] lg:w-[100%]"
          >
            {t("specialOffers.desc")}
          </p>
        </div>

        <div className="border-x border-[#515151]  2xl:pt-[217px] 2xl:ps-[25px]  lg:flex hidden flex-col lg:justify-center lg:pt-22 xl:pt-16 2xl:pb-[101px]  ">
          <h1
