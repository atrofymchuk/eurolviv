export const Header = () => {
  return (
    <div className="flex items-center justify-center bg-[#252526] lg:pt-[117px] pt-[73px] ">
      <div className="grid lg:grid-cols-[573px_575px_572px] grid-cols-[297px] lg:h-[564px]  text-[#EDE8E5] text-center lg:text-start ">
        <div className="border-s border-e border-[#515151] flex flex-col  lg:pt-[96px] lg:ps-[31px] pt-[53px] pb-[49px] lg:mb-0">
          ...
          <p className=" relative lg:top-[-96px] lg:w-[415px] uppercase lg:text-[18px] text-[12px] p-4 lg:leading-[22px] font-cofo pt-[20px] lg:pt-0">
        ...
        <div className="border-s border-e border-[#515151] flex  lg:pt-[267px] lg:ps-[25px] ">
