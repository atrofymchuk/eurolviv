  ...
  return (
    <div className="flex flex-col  xl:items-start xl:justify-start  justify-center items-center overflow-x-hidden overflow-y-hidden ">
      <div className="grid md:grid-cols-[24.2%_34.7%_25.8%_15.3%] grid-cols-[89.07%]  justify-center md:justify-stretch   mx-0 w-full">
        ...
        <div className="border-x   border-[#C7C7C7] ps-[14px] lg:ps-[48px] xl:ps-[30px] 2xl:ps-[]  flex flex-col mt  xl:pb-[43px]  2xl:pt-0 xl:pt-0 md:pt-10  pt-[10px]">
          <div className="2xl:mt-[90px] xl:mt-[85px] pb-5 xl:pb-0">
            <h1 className="text-[32px] w-[89.58vw] xl:space-y-[11px] sm:text-[28px] leading-[81%] md:text-[36px] lg:text-[48px] xl:text-[76px] 2xl:text-[100px] uppercase text-[#242425] tracking-[-0.07em]">
        ...
        <div className="flex flex-row md:flex-col 2xl:ps-[33px] justify-center md:justify-start border-x md:border-x-0 md:border-e border-[#C7C7C7] ">
          <div className=" md:max-w-[500px]  lg:max-w-fit flex flex-col md:flex-col items-center">
            <div className="flex flex-col 2xl:space-y-[19px] xl:space-y-[16px] md:space-y-2 space-y-3 md:order-none order-2 px-[14px_10px] pt-[30px] md:pt-0 ">
              <p className="sm:text-[16px] md:text-[12px] lg:text-[14px] xl:text uppercase 2xl:text-[20px] xl:text-[18px] 2xl:leading-[24px] xl:leading-[22px] font-cofo tracking-[-0.04em] 2xl:w-[443px]  2xl:p-0 xl:p-0 text-[14px] font-normal text-[#444444]">
                {t("home.about.desc.0")}
              </p>
              <p className="sm:text-[16px] md:text-base lg:text-[14px] uppercase 2xl:text-[20px] xl:text-[18px] 2xl:leading-[24px] xl:leading-[22px] font-cofo tracking-[-0.04em] 2xl:w-[443px]  2xl:p-0 xl:p-0  text-[14px] font-normal text-[#8C331B] md:text-[12px]">
                {t("home.about.desc.1")}
              </p>
              <p className="sm:text-[16px] md:text-base lg:text-[14px] uppercase 2xl:text-[20px] xl:text-[18px] 2xl:leading-[24px] xl:leading-[22px] font-cofo tracking-[-0.04em] 2xl:w-[443px]  2xl:p-0 xl:p-0  text-[14px] font-normal text-[#444444] md:text-[12px]">
                {t("home.about.desc.2")}
              </p>
              <Link
                to="/about"
            ...
            <div className="relative flex  md:w-full  justify-start self-start  md:order-none order-1 ">
              <div className="md:absolute top-0 left-0 max-w-[89.07%] pt-[20px] xl:pt-[50px] w-full md:w-fit  md:px-0 px-[14px_10px]">
                <h1 className="md:whitespace-nowrap  sm:text-[32px] inline md:block  xl:text-xl 2xl:text-2xl uppercase 2xl:text-[100px] xl:text-[70px] leading-[84%] text-[32px] md:text-[32px]  tracking-[-0.1em] text-[#242425]">
