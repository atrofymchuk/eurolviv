...
export const RoomsHome = () => {
  ...
  return (
    <div className="flex flex-col bg-[#A47762] relative items-center md:items-stretch overflow-x-hidden overflow-y-hidden xl:pb-[119px]">
      ...
      <div className=" w-full lg:h-[350px] h-[300px] md:h-[350px] grid-cols-[89.07%] grid  lg:flex flex-col justify-center   2xl:mt-[221px] xl:mt-[180px] lg:mt-[140px] ">
        <h1
        ...
        >
          ...
          <span className="flex lg:flex-col text-[24px] sm:text-[40px] md:text-[50px] lg:text-[60px] xl:text-[80px] 2xl:text-[100px]  tracking-[-0.09em] gap-y-[7px] leading-[81%] uppercase">
            ...
            <span className="leading-[81%]   xl:ps-36 2xl:ps-[205px]  w-auto ">
        ...
        <div className="flex flex-col w-full h-full items-center lg:items-start lg:justify-center   ">
          <div className="z-4 ">
            <div className="flex md:flex-row lg:ps-[80px]  md:ps-[60px] flex-col text-start items-center  md:items-start  2xl:items-start relative 2xl:h-[200px] xl:h-[190px] lg:h-[180px] md:h-[150px] sm:h-[130px] ">
              <div className="md:absolute flex md:flex-row items-center flex-col pt-[16px] md:pt-[35px]  space-y-[30px] md:space-y-0 text-center md:text-start md:gap-[20px] xl:gap-x-[60px] md:hidden lg:flex">
                <p
      ...
      <div className=" max-w-screen relative  z-0 mb-[34px] md:mb-0 mt-19 md:mt-0  xl:mb-[30px] w-full md:h-[500px]  h-[350px]">
        <div className="z-10 absolute  2xl:h-[650px] xl:h-[750px] lg:h-[570px] md:h-[500px] sm:h-[470px] h-[457px] w-full  ">
          <RoomsSlider ref={sliderRef} sliderProps={sliderProps} />
        </div>
      </div>

      <div className="h-[64px] w-full hidden md:flex">
        <div className="hidden md:flex  w-full justify-between 2xl:translate-y-3 xl:-translate-y-14 lg:-translate-y-28 md:-translate-y-30 ">
          <button
