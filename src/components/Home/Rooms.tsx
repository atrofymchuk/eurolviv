...
export const RoomsHome = () => {
  return (
    <div className="flex flex-col bg-[#A47762]">
      <div className="grid grid-cols-[365px_667px_446px] ms-[100px] h-[580px] ">
        <div className="border-x border-[#C29986] flex flex-col justify-center ">
          <div className="translate-y-[130px]">
            ...
            <div className="flex xl:flex-row text-start items-center xl:items-start relative h-[200px]">
              <div className="absolute flex items-center justify-center xl:justify-start ">
                ...
                <Link to='/rooms' className="uppercase text-[#242425] font-semibold translate-x-[480px] bg-[#EDE8E5] w-fit h-fit xl:px-[22.5px] xl:py-[13px] py-[12.5px] px-[14.5px] rounded-full hover:cursor-pointer">
                  переглянути номери
                </Link>
              </div>
            </div>
        ...
        <div></div>
        <div className="border-x border-[#C29986] h-full flex flex-col justify-center">
