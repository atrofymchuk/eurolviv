...
export const RoomsHome = () => {
  ...
  return (
    <div className="flex flex-col bg-[#A47762] relative items-center md:items-stretch overflow-x-hidden overflow-y-hidden ">
      <div className="grid z-0 absolute md:grid-cols-[5.2%_19%_34.7%_25.8%] grid-cols-[89.07%] lg:h-[1580px] md:h-[1000px]  h-[968px] md:items-start justify-center md:justify-start w-full  ">
        ...
        <div className="flex flex-col w-full h-full md:justify-center  lg:translate-y-[50px] ">
          ...
          <h1 className="uppercase   text-[24px] leading-[90%] tracking-[-7%] relative whitespace-nowrap text-[#EDE8E5]">
            ...
            <div className="flex md:flex-row lg:ps-[80px]  md:ps-[60px] flex-col text-start items-center md:items-start  2xl:items-start relative 2xl:h-[200px] xl:h-[190px] lg:h-[180px] md:h-[150px] sm:h-[130px] ">
              <div className="md:absolute flex md:flex-row flex-col pt-[30px] md:pt-[35px]  space-y-4 md:space-y-0 text-center md:text-start md:gap-[20px] xl:gap-x-[75px]">
                <p className="uppercase  2xl:w-[433px] xl:w-[400px] lg:w-[330px] md:w-[300px] sm:w-[280px] w-[250px] 2xl:text-[16px] xl:text-[15px] lg:text-[14px] md:text-[13px]  
                text-[14px]  text-[#E9E9E9] ">
                  {t("home.rooms.desc")}
                </p>
                <div className="flex justify-center items-center  ">
                  <Link
                    to="/rooms"
                    className="uppercase text-center block text-[#242425] font-semibold hover:bg-black hover:text-[#EDE8E5]   bg-[#EDE8E5] whitespace-nowrap 2xl:px-[19px] 2xl:py-[11px] xl:px-[20px] xl:py-[12px] lg:px-[18px] lg:py-[10px]  py-[12.5px] px-[14.5px] 
      ...
      <div className="h-[64px] w-full hidden md:flex">
        <div className="hidden md:flex  w-full justify-between 2xl:-translate-y-30 xl:-translate-y-38 lg:-translate-y-28 md:-translate-y-20 ">
          <button
