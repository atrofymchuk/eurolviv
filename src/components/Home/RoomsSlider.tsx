...
export const RoomsSlider =  forwardRef<Slider, RoomSSliderProps>((_,ref) => {
  ...
  const getSlideClass = (index: number) => {
    return index === currentSlide
      ? "xl:w-[589px] xl:h-[416px] w-[150px] h-[150px] z-10 "
      : "xL:w-[475px] xl:h-[311px] w-[150px] h-[150px] ";
  };
        ...
        {rooms.map((el, index) => (
          ...
          >
            <img
              ...
              alt={`Slide ${index}`}
              className="xl:w-full xl:h-full object-cover  transition-transform duration-300 my-auto"
            />
