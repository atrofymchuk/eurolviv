...
export const HomeSeoText = () => {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 hidden lg:grid lg:grid-cols-[29.7%_40.6%_29.7%]">
        ...
        <div className="border-x border-[#C7C7C7]">
            ...
            {CONTENT_SECTIONS.map((section, index) => (
              ...
              >
                <div className="flex gap-[14px] lg:gap-[18px]">
                  <span
                    className="mt-[4px] shrink-0 font-cofo-medium text-[12px] uppercase tracking-[-0.04em] text-[#A47762] md:text-[13px] xl:text-[0.82vw]"
                    aria-hidden
                  >
          ...
          <div className="border-t border-[#C7C7C7] bg-[#252526] px-[20px] py-[36px] text-white lg:px-[36px] lg:py-[48px]">
            <div className="grid gap-[24px] lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end lg:gap-[32px]">
              <div>
                <h3 className="max-w-[22ch] font-cofo-medium uppercase leading-[110%] tracking-[-0.05em] text-[22px] md:text-[26px] xl:text-[1.75vw]">
