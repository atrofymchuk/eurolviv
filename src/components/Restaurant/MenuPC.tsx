...
export const MenuPC = ({className}:MenuPCToProps) =>{
    return(
        ...
        <div className={cn(`flex  md:justify-end  md:pe-2.25 ${className}`)}>
            <InViewWrapper>
            <img
              src={coffe}
              alt=""
              className={cn(`lg:w-[326px] xl:w-[426px] 2xl:w-[526px] lg:h-[686px] md:w-[300px] md:h-[300px] w-[97px] h-[146px] object-cover `)}
            />
            </InViewWrapper>
          </div>
