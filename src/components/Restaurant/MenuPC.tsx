    ...
    return(
        ...
        <div className={cn(`flex md:justify-end space-x-[5px] border-[#B3B3B3] md:pe-2.25 ${className}`)}>
            ...
            <img loading="lazy"
              src={coffe}
              alt=""
              className={cn(`lg:w-[306px] lg:h-[486px] md:w-[240px] md:h-[300px] w-[25.1vw] h-[37.9vw] object-cover 2xl:w-[23.8vw] 2xl:h-[35.7vw]`, {
          ...
          <div className={cn(`flex flex-col text-center lg:border-x border-[#B3B3B3] items-center ${className}`)}>
            ...
            <img loading="lazy"
              src={spagetti}
              alt=""
              className={cn(`lg:w-[326px] lg:h-[486px] md:w-[300px] md:h-[300px] w-[25.1vw] h-[37.9vw] object-cover 2xl:w-[26.7vw] 2xl:h-[35.7vw]`, {
