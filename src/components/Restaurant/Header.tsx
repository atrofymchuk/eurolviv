...
export const TerraseHeader = () => {
  return (
    <div className="relative w-full lg:h-[1157px] h-[821px] flex items-center justify-center flex-col">
      ...
      <div className="flex space-x-[13px] mt-[88px]">
      ...
      <div className="absolute right-0 top-1/3 transform -translate-y-1/2 rotate-[-90deg] origin-bottom-right bg-[#252526] rounded-full lg:py-[13px] lg:px-[25px]">
        <p className="uppercase text-white font-cofo font-bold tracking-widest text-lg lg:text-[16px] lg:leading-[20px]  ">
          вартість банкету
        </p>
      </div>
    </div>
