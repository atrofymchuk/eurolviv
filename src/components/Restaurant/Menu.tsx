    ...
    <div className="flex flex-col items-center justify-center md:w-[93.16%] w-[89.067%] mx-auto md:border-x border-[#B3B3B3] border-t ">
      <div>
        <div className={cn(`grid  md:h-full h-[521px] grid-cols-1`,
          isEng ? "md:grid-cols-[35.7%_28.8%_35.6%]" : "md:grid-cols-[35.7%_28.9%_35.1%]"
        )} >
          ...
          <div className="2xl:h-[375px] xl:h-[305px] lg:h-[265px] flex  border-x   flex-col  border-[#B3B3B3] items-center lg:justify-end text-center lg:pb-[70px] md:pb-[50px] pb-[10px] pt-[55px] lg:pt-0 ">
            ...
            <h1 className={cn(`uppercase 2xl:text-[3.34vw] lg:text-[54px]  leading-[94%] text-[32px] mt-[9px]  tracking-[-0.07em] md:whitespace-nowrap`, {
          ...
          <div className="2xl:h-[329px] xl:h-[259px] lg:h-[209px] flex  border-x   flex-col  border-[#B3B3B3] text-center  items-center">
            ...
            <button
              ...
              className="font-cofo-medium uppercase 2xl:w-[10.9vw] 2xl:h-[2.4vw] text-[#8C331B] lg:w-[209px] border-[#8C331B] border hover:cursor-pointer hover:bg-[#8C331B] hover:text-white rounded-full
               lg:text-[16px] mb-[30px] lg:mb-0 text-[13px] lg:mt-[19px] mt-[24px] lg:py-[10px] py-[9.25px] px-[10.25px]   w-[171px]"
            >
