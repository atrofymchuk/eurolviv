      ...
      <div className={cn(`w-full grid  ${isTerrasePage ? 'max-w-[90.31%]':'md:max-w-[93.1%] max-w-[89.1%]'} grid-cols-1 border-[#B3B3B3] border-x lg:border-b-0 `)}>
        <div className="lg:w-fit 2xl:ps-[78px] xl:ps-[68px] lg:ps-[58px] lg:h-[490px] h-[337px] flex flex-col justify-center lg:text-start text-center">
          ...
          <div className=" flex items-center lg:flex-row flex-col  xl:space-x-[188px] lg:space-x-[80px]   lg:space-y-0 space-y-[24px] lg:mt-[37px]">
            <p className="text-[#242425] 2xl:text-[16px]  md:text-[14px] text-[12px] uppercase 2xl:w-[340px] w-[265px] ">
              {t('reviews.desc2')}
            </p>

              <button className="font-cofo-medium w-[160px] lg:w-[208px] hover:cursor-pointer uppercase bg-[#8C331B] text-[#FFFFFF] hover:text-[#8C331B] border border-[#8C331B] hover:bg-[#FFFFFF]  lg:py-[10px] px-[12px] py-[10px] rounded-full h-fit lg:text-[16px] text-[12px] ">
              {t('buttons.bookTable')}
            </button>
          </div>
        </div>
