...
export const Reviews = ({isTerrasePage = false}: ReviewsToProps) => {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center ">
      <div className={cn(`w-full grid  ${isTerrasePage ? 'max-w-[90.31%]':'md:max-w-[93%] 2xl:max-w-[93.1%] xl:max-w-[93.2%] max-w-[89%]'} grid-cols-1 border-[#B3B3B3] border-x lg:border-b-0 `)}>
        <div className="lg:w-fit 2xl:ps-[78px] xl:ps-[68px] lg:ps-[58px] lg:h-[490px] h-[337px] flex flex-col justify-center lg:text-start text-center">
          ...
          <h1 className="uppercase lg:w-[892px] 2xl:w-[46.46vw]  text-[#242425] 2xl:text-[5.21vw] xl:text-[90px]  leading-[87%] xl:pt-[17px] pt-[6px] lg:text-[84px] md:text-[48px] text-[32px] tracking-[-0.07em] pb-[24px] lg:pb-0 ">
