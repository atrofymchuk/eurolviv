...
export const Navigation = forwardRef<Slider, NavigationToProps>(
  ({ isTerrasePage }, ref) => {
      ...
      <div className="flex flex-col md:items-end lg:justify-between md:justify-end justify-center items-center ">
        <div
          className={cn(
            `flex ${
              isTerrasePage
                ? "xl:max-w-[95.16%] max-w-[90.31%] "
                : "md:max-w-[96.6%] max-w-[89.1%]"
            }   justify-between lg:mt-0 border-b border-x  border-t  border-[#B3B3B3] w-full`
          )}
        >
          <button
