...
import { useTranslation } from "react-i18next";
  ...
  return <div className="xl:ms-[37px] lg:ms-[20px]  md:block items-center pt-4.5 lg:pt-0 flex flex-col md:border-b-0 md:border-e-0 border-b border-e border-[#C7C7C7] lg:order-4 order-4 lg:w-fit">
