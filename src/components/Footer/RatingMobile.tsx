  ...
  return (
    <div className="lg:block hidden px-4  ps-0">
      <img
        src={rating}
        alt="rating"
        className="lg:mt-8.75 xl:mt-[20px] 2xl:mt-[1.823vw]"
      />
      <p className="2xl:mt-[0.677vw] xl:mt-[10px] mt-[13px] 2xl:text-[0.833vw]  xl:text-[1.09vw] lg:text-[14px] font-cofo-medium uppercase  leading-[1.28]">
        Booking.com
      </p>
      ...
      <div className="flex space-x-4 2xl:mt-11.75 xl:mt-[30px] mt-[35px]">
        ...
        <img src={mastercard} alt="Mastercard" className="h-7.5" />
      </div>
