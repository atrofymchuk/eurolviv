...
export const RatingMobile = () => {
  return (
    <div className="lg:block hidden px-4  ps-0">
      ...
      <p className="2xl:mt-[0.677vw] mt-[13px] 2xl:text-[0.833vw]  xl:text-[1.09vw] font-cofo-medium uppercase  leading-[1.28]">Booking.com</p>
      <p className="2xl:mt-[0.313vw] mt-[6px] 2xl:text-[0.833vw] xl:text-[1.09vw] lg:text-[18px] text-[#999999] font-cofo uppercase leading-[1.28]">
