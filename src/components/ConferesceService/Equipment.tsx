  ...
  return (
    <div className="flex  bg-[#F2EFEC] justify-center flex-1 2xl:h-[231px 2xl:h-[12vw] w-full">
      <div className="grid grid-cols-1  py-[41px] lg:py-0 lg:grid-cols-[20.58%_42.9%_35%] lg:w-full w-[79.1%]   border-[#D9D9D9] border-x lg:border-x-0  box-border">
        <div className="border-[#D9D9D9] flex items-center 2xl:ps-[3.7vw] ps-[10px] md:ps-[20px] md:p-6 lg:pb-8 ">
          <h1 className="pb-[10px] uppercase text-[24px] sm:text-[24px] md:text-[32px] lg:text-[32px] xl:text-[2.7vw]  2xl:text-[2.1vw] leading-[100%] tracking-[-0.05em] text-[#8C331B]  ">
        ...
        <div className="flex lg:items-center lg:justify-center w-full lg:border-x border-[#D9D9D9] ps-[10px] md:ps-[20px] lg:ps-0 pt-[35px] md:pt-0 xl:pb-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-[1.4vw] 2xl:w-[33.2vw] xl:w-[37vw]">
            <div>
                ...
                >
                  <div className="flex items-center gap-x-2.5 gap-y-[3px]">
                    <img
                      ...
                      src={icon.src}
                      alt={icon.text}
                      className="w-[22px] h-[22px]  md:w-[22px] md:h-[22px] lg:w-6 lg:h-6 xl:w-[1.7vw] xl:h-[1.7vw]  2xl:w-[30px] 2xl:h-[30px]"
                    />
                    <span className="uppercase text-[#383838] text-[14px] sm:text-[16px] md:text-[18px] lg:text-[16px] xl:text-[18px] 2xl:text-[1.05vw]">
                      {t(icon.text)}
                    </span>
                  </div>
                </div>
