...
export const About = ({ item }: AboutToProps) => {
  ...
  return (
    <div className="flex flex-col items-center">
      <div className="grid lg:grid-cols-[393px_819px_708px] grid-cols-[40px_295px_40px] items-center justify-center lg:items-start lg:justify-normal">
        ...
        <div className="flex   border-t  lg:border-e border-b lg:border-b-0 border-[#C7C7C7]  flex-col h-full justify-center p-2.5 lg:p-0  lg:items-center order-2 lg:order-none">
