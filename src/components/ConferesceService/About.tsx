...
export const About = memo(({ item, isOnTop }: AboutToProps) => {
  ...
  return (
    <div className="flex flex-col">
      <div
        className={cn(
          `grid lg:grid-cols-[21%_42%_37%] grid-cols-[11%_78%_11%] items-center justify-center 2xl:items-start 2xl:justify-normal`
        )}
      >
      ...
      <div className="grid flex-col lg:grid-cols-[63%_37%] h-auto grid-cols-1 order-7 lg:order-none">
        ...
        <div className="flex flex-col lg:items-start md:justify-start justify-center items-center border-x md:border-x-0 2xl:border-x-0 border-t lg:border-s-0 2xl:px-[41px] border-[#C7C7C7] 2xl:w-auto flex-1">
          <div className="lg:flex flex-col w-[79.1%] flex justify-center 2xl:items-center 2xl:w-fit lg:p-0 p-2.5 pb-[40px] pt-[22px] border-x lg:border-x-0 border-[#C7C7C7] 2xl:border-x-0 h-auto lg:w-auto">
            ...
            <RoomDescription 
              pOne={item.about.pOne}
              pTwo={item.about.pTwo}
            />
