...
export const RoomTitle = memo(({ title, size, isOnTop, id }: RoomTitleProps) => {
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row 2xl:items-center justify-center order-5 lg:order-none h-[29.07vw] min-h-[109px]" id={id}>
      <div
        className={cn(
          `${
           ...
           2xl:py-[1.83vw_1.67vw] xl:p-[2vw] lg:p-[2.2vw] md:p-[2.4vw] w-full relative h-[29.07vw] ps-[2.2vw] min-h-[109px]`
        )}
      >
