    ...
    return (
      <div className="2xl:pt-[42px] xl:pt-[30px] lg:pt-[30px]   pt-[52px] flex flex-col h-full justify-between">
        <div>
          ...
          <p
            className={`2xl:text-[1.05vw] text-[12px] sm:text-[14px] pt-[24px] md:text-[14px] lg:text-[14px] xl:text-[1.05vw] leading-[120.1%] 
          tracking-[-0.04em]  text-[#444444] h-fit uppercase lg:flex hidden
           ${isCustomWidth && isOnTop ? "xl:w-[89%]" : ""}
          ${isCustomWidth && !isOnTop ? "xl:w-[90%]" : ""}
            ${isOnTop && !isCustomWidth ? "2xl:w-[96%] xl:w-[90%]" : ""}
        ...
        <div className="flex-1 flex items-center">
          <ViewMenuButton className="text-[14px] 2xl:text-[0.74vw] hidden lg:flex 2xl:w-[10.6vw] 2xl:h-[2.3vw] items-center justify-center">
