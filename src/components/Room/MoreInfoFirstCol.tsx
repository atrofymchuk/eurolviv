...
export const MoreInfoFirstCol = ({
  ...
  return (
    <div className="flex flex-col lg:py-20 pt-[54px] pb-[28px] md:py-10 2xl:px-[21px_17px] xl:px-[14px_10px] lg:px-[14px_10px]  md:px-[10px_8px] h-full">
      {isShowOtherInfo ? (
        <h1 className="text-white 2xl:text-[48px] xl:text-[42px] px-[10px] lg:px-0 tracking-[-0.07em] text-[32px]  leading-[104%] uppercase font-cofo md:pb-[15px] xl:pb-[51px] lg:pb-[20px] ">
          {t("room.moreInfo.title2")}
        </h1>
      ) : (
        <h1 className="text-white text-[32px]  tracking-[-0.07em] 2xl:text-[48px] xl:text-[42px]  leading-[104%] uppercase font-cofo xl:pb-[51px] pb-[20px] hidden md:block">
          {t("room.moreInfo.title")}
        </h1>
      )}
      {isShowOtherInfo ? (
        <div>
          <ul className="flex flex-col 2xl:gap-2 gap-[2px] w-full pt-10 md:pt-0 ps-[10px] lg:ps-0 ">
            {amenities.map((item) => (
              <li
                key={item.src}
