  ...
  return (
    <div className="relative w-full box-border">
      <div className="w-full max-w-[100vw] overflow-hidden">
        <Slider {...settings} ref={ref} className="special-offers-slider w-full overflow-hidden">
          {specialOffers.map((el, index) => (
            <div
              key={index}
              className={cn(`border lg:p-5 md:p-4 p-3.5 h-[426px] md:h-[540px] lg:h-[668px] border-t border-[#C7C7C7] relative w-full mx-auto ${
            ...
            >
              <InViewWrapper className="relative">
                <img
                  ...
                  alt={t(el.title)}
                  className={cn(
                    `w-[240px] h-[232px] md:w-[340px] md:h-[320px] lg:w-[444px] lg:h-[421px] object-cover max-w-full ${el.classes}`
                  )}
                />
                <div
                  className={cn(`absolute max-w-[80%] md:max-w-full top-0 left-0`, {
