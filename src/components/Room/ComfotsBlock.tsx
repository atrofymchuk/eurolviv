    ...
    <div className={`${style.bgColor}`}>
      <div className="container-fluid mx-auto max-w-[84.04%] ">
        ...
        >
          ...
          >
            <div
              className="w-[90%] lg:w-fit xl:w-full  flex-col items-center justify-center
           "
            >
              <h1
                className={`uppercase ${style.headerColor} font-cofo
                text-[24px] sm:text-[28px] md:text-[28px] lg:text-[32px] xl:text-[48px]   lg:ms-[20px]
                leading-[104%]
                2xl:mb-[51px] lg:mb-[20px]
...
`}
          ...
          >
            <div
              ...
              lg:pt-[200px] xl:pt-[120px] 2xl:pt-[270px] md:pt-[45px]"
            >
              <ul className="space-y-2 sm:space-y-3 md:space-y-1 lg:space-y-2 xl:space-y-2">
                {icons.map((item, index) => (
                  <li
                    key={index}
                    className={`flex items-center gap-x-1 ${style.text} 
                      uppercase font-cofo`}
                  >
                    <InViewWrapper>
                      <img
                    ...
                    <p
                      className="text-[10px] sm:text-[12px] md:text-[12px] lg:text-[12px] xl:text-[16px]
