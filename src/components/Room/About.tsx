  ...
  return (
    <div className="   ">
      <div className="grid md:grid-cols-[20.47%_42.66%_36.88%]   grid-cols-[10.67%_78.67%_10.67%] items-center justify-center 2xl:items-start 2xl:justify-normal max-w-[84.06%] md:max-w-full mx-auto md:mx-0">
        ...
        <div className="2xl:h-[109px] border-x md:hidden md:border-x-0 md:border-e border-b md:border-b-0   w-full h-[109px] border-[#C7C7C7] order-5 md:order-none"  />
        <div className="2xl:h-[109px] border-x md:border-x-0 md:border-e  w-full h-[109px] border-[#C7C7C7] order-6 md:order-none "  />
        <div className=" h-full border-t 2xl:h-[14rem] xl:h-[10rem]  md:border-e border-b md:border-b-0 border-[#C7C7C7] flex flex-col justify-end md:justify-start  p-2.5 2xl:p-0
        ...
        <div className="flex  order-5 md:order-none h-full">
            <AboutRoomTitle nameRoom={nameRoom} />
        </div>

        <div className=" md:border-t border-x md:border-x-0 h-full border-[#C7C7C7] order-8"></div>
      </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <BookLink
              to={`/booking/${nameRoom}`}
              className="uppercase bg-[#8C331B] text-white w-fit 
            "
            >
