...
export const SpecialOffers = () => {
  ...
  return (
    <div className="relative w-full h-[588px] lg:h-[976px] flex justify-center items-center overflow-hidden flex-col">
  ...
  <div className="absolute right-0 flex w-[1680px] -translate-16 justify-between">
    <button
