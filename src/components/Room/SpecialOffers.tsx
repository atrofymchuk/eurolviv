...
export const SpecialOffers = ({width = 1595}:SpecialOffersToProps) => {
  const sliderRef = useRef<Slider | null>(null);

  return (
    <div className="relative w-full h-[658px] lg:h-[976px] flex justify-center items-center overflow-hidden flex-col">
      <div className={`relative border-s border-[#C7C7C7] h-full w-[296px] mb-[71px] lg:mb-[75px] lg:w-[${width}px]`}>
