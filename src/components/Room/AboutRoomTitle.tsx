...
export const AboutRoomTitle = ({ nameRoom }: { nameRoom: string }) => {
  ...
  >
    <h1 className="uppercase text-[#242425] 2xl:text-[100px] xl:text-[80px] text-[32px] lg:text-[60px] 2xl:leading-[81px] 2xl:font-normal leading-[86%] tracking-[-0.026em] flex flex-col pb-[19px] md:pb-0 justify-end md:justify-center lg:h-full">
      {t(nameRoom).length > 16 ? (
        <>
          {(() => {
            ...
            return (
              <>
                <span className="md:whitespace-nowrap order-1 md:order-1 block mt-auto">
                  {firstLine}
                </span>
