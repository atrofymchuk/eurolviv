...
export const AboutRoomTitle = ({ nameRoom }: { nameRoom: string }) => {
  ...
  return (
    <div
      className={cn(
        `md:border-t md:border-e ps-[10px]  md:justify-start md:ps-2.5 flex 2xl:block border-[#C7C7C7] 2xl:p-[1.82vw] xl:p-[1.56vw] w-full relative`
      )}
    >
      <h1
        className="uppercase text-[#242425] 2xl:text-[5.21vw] xl:text-[5.25vw] text-[32px] 
    lg:text-[60px]  2xl:font-normal xl:leading-[86%] leading-[86%] tracking-[-0.026em] flex flex-col 
