  ...
  return (
    <div className="w-full flex justify-center">
      <div className="grid lg:grid-cols-2 grid-cols-1 w-full">
        {translatedSuggestions.map(({ img, type, translatedTitle, translatedSize, translatedDesc }, index) => (
          <div key={index} className="bg-[#252526] relative lg:pt-[240px] pt-[100px] flex flex-col">
            <div className="relative">
              <div className="absolute inset-0 z-10 bg-gradient-to-b from-[#252526] to-transparent"></div>
              <InViewWrapper>
                <img src={img} alt={type} className="lg:w-full lg:h-[654px] object-cover" />
              </InViewWrapper>
            </div>

            <div className="absolute top-0 flex flex-col items-center text-center text-white z-10 lg:p-4 p-[51px] w-full lg:h-[250px]">
