        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <h1
                  className="uppercase text-white font-cofo text-center lg:text-left
          ...
          >
            ...
            >
              ...
              <div
                className="mt-8 sm:mt-10 md:mt-12 lg:mt-[148px]
              ...
              >
                <InViewWrapper>
                  ...
                  />
                  <p
                    className="text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] mt-auto
                  leading-[104%]"
                  >
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => onOpenModal("order")}
                className={`mt-6 sm:mt-8 md:mt-10 lg:mt-[100px] ${
                  isShowAdditionalPlace ? "hidden" : "flex"
                }
                  uppercase font-semibold 
                  bg-[#EDE8E5]    text-[#A47762]
                  text-[12px] sm:text-[13px] md:text-[14px]
