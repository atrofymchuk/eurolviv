    ...
    >
      <div className="">
        ...
        <div className="2xl:h-[297px] xl:h-[280px] lg:h-[260px] md:h-[220px] h-[191px]">
          <div className="flex justify-between mx-auto 2xl:pt-[19px] xl:pt-[17px] lg:pt-[15px] md:pt-[12px] pt-[10.5px] md:px-6.75 items-center">
            <div className="flex items-center">
              <img src={square} alt="square" className="lg:w-6 w-4" />
            ...
            <div className="flex items-center">
              <img src={guest} alt="square" className="lg:w-6 w-4" />
          ...
          <div className="flex justify-center items-center h-full">
            <div className="flex flex-col text-center items-center justify-between h-full 2xl:max-h-[200px] xl:max-h-[180px] lg:max-h-[160px] md:max-h-[140px] max-h-[125px] w-full 2xl:max-w-[472px] xl:max-w-[440px] lg:max-w-[400px] md:max-w-[340px]">
              <div className="flex-1 flex flex-col justify-start w-full">
                <h1 className="font-cofo uppercase 2xl:text-[40px] xl:text-[36px] lg:text-[32px] md:text-[28px] text-[24px] 2xl:leading-[36px] xl:leading-[32px] lg:leading-[28px] md:leading-[24px] leading-[22px] tracking-[-0.06em] font-cofo-medium">
                  {t(room.title)}
                </h1>
              ...
              <Link
                to={`/rooms/${room.type}`}
                className="uppercase 2xl:py-[10px] xl:py-[9px] lg:py-[8px] py-[8px] md:mb-5 2xl:px-[20px] xl:px-[18px] lg:px-[16px] px-[9px] 2xl:text-[18px] xl:text-[16px] lg:text-[14px] text-[12px] border rounded-full text-[#A47762] hover:bg-[#A47762] hover:text-white font-cofo font-cofo-medium transition-colors"
              >
                {t("buttons.viewRoom")}
              </Link>
            </div>
