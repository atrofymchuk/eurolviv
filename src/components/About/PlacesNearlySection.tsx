...
export const PlacesNearbySection = ({
  ...
  return (
    <div className="p-4 ps-[17px] xl:p-7 2xl:pt-[2.292vw] pt-[31px] border-b border-t lg:border-t-0 border-[#c7c7c7] flex flex-col min-h-full justify-between">
      <h2 className="text-[#8C331B] text-[6.4vw] lg:text-[26px] xl:text-[2vw] 2xl:text-[2.083vw] tracking-[-0.04em] leading-[100%] text-center lg:text-left uppercase">
      ...
      <div className="lg:mt-auto mt-[42px] ">
        <h2
          className={cn(
            "text-[#8C331B] text-[6.4vw] lg:text-[28px] uppercase xl:text-[2vw] xl:w-[45%] 2xl:text-[2.083vw] 2xl:w-[18.068vw] leading-[100%] text-center lg:text-left ",
            {
