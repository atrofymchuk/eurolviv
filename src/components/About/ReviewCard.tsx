...
export const ReviewCard = ({ review, reviewHeader, index }: { review: ReviewProps, reviewHeader: string, index: number   }) => {
  ...
  return (
    <div className="flex flex-col 2xl:w-[27.75vw] w-[79.733vw]  2xl:h-[19.8vw] xl:w-[27.235vw]  xl:h-[21.135vw] h-[59.7vw] bg-[#EDE8E5] mt-[10px]  me-1">
      <div className="pt-[16px] ps-[17px] xl:pt-[24px] xl:ps-[24px] 2xl:ps-[34px] 2xl:pt-[33px] ">
        <h1 className="leading-[120%] uppercase xl:text-[2.267vw] text-[5.333vw]  text-[#A47762]  2xl:text-[2.5vw] font-cofo-medium font-cofo xl:tracking-[-0.04em]">
          {review.name}
        </h1>
        <p className="text-[#727272] font-cofo uppercase 2xl:text-[1.042vw] text-[14px]">
