    ...
    <section className="flex justify-center items-center flex-col w-full ">
      <div className="fluid-container mx-auto border-x border-[#C7C7C7] grid grid-cols-1 lg:grid-cols-[74.42%_25.58%] items-center justify-center w-full max-w-[89.58%]">
        ...
        >
          ...
          <div className="flex flex-col lg:items-end  items-center">
            ...
            >
              ...
              <p className={`w-[90%] block 2xl:text-[20px] lg:text-[18px] md:pt-4 pt-6 tracking-[-0.07em]  lg:pt-5  text-[3.2vw] leading-[120%] ${isCustomWidth ? "xl:text-[16px]" : "xl:text-[14.5px]"}`}>
                {t("about.about.desc.0")}
              </p>
              <p className={`w-full block 2xl:text-[20px]  lg:text-[18px] text-[3.2vw] tracking-[-0.07em]  leading-[120%] ${isCustomWidth ? "xl:text-[16px]" : "xl:text-[14.5px]"}`}>
        ...
        <div className=" flex justify-center items-center w-full border-[#C7C7C7] border-b md:p-4 p-3">
          <InViewWrapper>
            <img
              ...
              src={sectionAbout}
              alt="Reception"
              className={`w-full 2xl:max-h-[543px]  max-h-[36.27vw] object-cover object-[0%_35%] ${isCustomWidth ? "xl:max-h-[450px]" : "xl:max-h-[380px]"}`}
            />
          </InViewWrapper>
        </div>
        ...
        <div className="lg:border-s  border-[#C7C7C7] flex flex-col h-full text-xs sm:text-sm md:text-base  2xl:text-2xl font-normal tracking-[-0.01em] text-center lg:text-left">
          <p className={`text-[3.2vw] sm:text-sm md:text-[14px]   2xl:text-[20px] text-[#252526] p-[15px] pb-[20px] pt-[26px] lg:pt-[18px] 2xl:px-[24px_0px] 
          ...
          <p
            className={` custom-md-font p-[15px] pb-[20px]  2xl:px-[24px_4px] xl:pt-[20px] 
              ...
              ${isCustomSecondaryMobile ? "px-[18px] " : ""}
               text-[3.2vw] sm:text-sm md:text-[14px]  pt-[26px]   2xl:text-[20px] mt-auto leading-[120%] tracking-[-0.01em] uppercase text-[#8C331B] `}
          >
