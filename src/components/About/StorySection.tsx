...
export const StorySection = () => {
  return (
    <section className="flex justify-center px-6 ">
     <div className="grid grid-cols-1 md:grid-cols-3 items-center md:max-w-[1720px] w-full px-6 box-border border-collapse">
  <div className="md:col-span-2 border-l border-r border-b md:border-b-0 max-w-[334] md:w-full border-[#C7C7C7] -me-[0.1%] md:h-[384px] p-4">
  ...
  <div className="grid text-sm md:text-[24px] text-[#252526] uppercase text-center md:text-end mt-3.5 mb-5 font-semibold">
      ...
      <span className="md:pr-[49.6%] md:text-end text-center">з сучасною вишуканістю</span>
    </div>
  </div>
  ...
  <div className="md:col-span-2 max-w-[334] row-span-1 border-r border-l md:border-r-0 flex justify-center items md:w-full border-[#C7C7C7] border-b p-0">
    <img
      src={Section}
      alt="Reception"
  ...
  <div className="md:col-span-1 row-span-1 font-cofo border-l max-w-[334] md:w-full border-r border-[#C7C7C7] flex flex-col flex-grow h-full text-[24px] font-normal  tracking-[-0.01em] text-left">
    <p className="md:text-lg text-gray-800 font-cofo p-4 uppercase font-normal w-full text-center md:text-start text-sm md:leading-[24px] leading-[14px]">
      ...
      <span className="font-bold text-[#8C331B]"> 1973</span> році, коли тут був
  ...
  <div className="col-span-1 md:col-span-3 border-x border-[#C7C7C7] max-w-[334]  h-[43px] md:h-[119px]"></div>
</div>
