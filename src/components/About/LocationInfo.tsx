...
export const LocationInfo = ({ t }: { t: TFunction }) => {
  ...
  return (
    <div className="flex flex-col justify-center lg:justify-start items-center pb-[30px] lg:pb-0 lg:items-start border-t-0 p-4 md:p-0 pt-[61px] lg:mt-0 2xl:h-[692px] xl:h-[39.063vw] xl:pt-[50px] 2xl:pt-[73px]">
      <div className="2xl:ms-[52px] xl:ms-[42px]">
        ...
        <p className="font-cofo-medium text-[3.2vw] tracking-[-0.04em] leading-[115%] xl:text-[16px] 2xl:text-[1.042vw] text-center lg:text-left xl:w-[70%] uppercase pt-6 w-4/5 mx-auto lg:mx-0 2xl:w-2/3">
          {t("about.whereWeAre.rating")}
        </p>
        <div className={`flex justify-center text-[3.2vw]! lg:justify-start mb-[4px] ${isSpecialWidth ? "mt-6" : "mt-0"}`}>
          <RouteButton className="mt-6  2xl:mt-[75px] xl:mt-[30px] 2xl:w-[223px] xl:w-[200px] xl:text-[14px] text-center w-[171px] 2xl:text-[0.729vw] "/>
        </div>
      </div>
    </div>
  );
