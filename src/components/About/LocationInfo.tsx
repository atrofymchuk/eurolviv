  ...
  return (
    <div className="flex flex-col justify-center lg:justify-start items-center pb-[30px] lg:pb-0 lg:items-start border-t-0 p-4 md:p-0 pt-[61px] lg:mt-0 2xl:h-[36.042vw] xl:h-[39.063vw] xl:pt-[50px] lg:pt-[40px] 2xl:pt-[73px]">
      <div className="2xl:ms-[52px] xl:ms-[42px] lg:ms-[30px]">
        ...
        <h1 className={`uppercase text-[8.533vw] 2xl:text-[5.208vw] md:font-cofo-medium lg:text-[48px]  pt-[8px] lg:pt-[26px] text-center lg:text-left leading-[94%]  tracking-[-0.04em] lg:tracking-[-0.1em]
           ${isSpecialWidth ? "xl:text-[5.1vw]" : "xl:text-[5vw]"}`}>
          {t("about.whereWeAre.title")}
        </h1>
        <p className={`text-[#8F8F8F] text-[3.2vw]  tracking-[-0.01em] lg:text-[14px] lg:w-[80%]
        ...
        <p className={`font-cofo-medium text-[3.2vw] lg:text-[14px] tracking-[-0.04em] leading-[115%] xl:text-[1.25vw] 2xl:text-[1.042vw] text-center lg:text-left
