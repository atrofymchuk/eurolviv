  ...
  return (
    <div className={`  lg:border-r border-b-0  border-[#c7c7c7] flex flex-col items-center  lg:items-start pb-[30px] lg:pb-0 lg:border-b`}>
      <div className={`2xl:ps-[2.604vw] xl:ps-[2.7vw]  flex flex-col items-center lg:items-start `}>
        ...
        <h1 className={` ${isSpecialWidth ? "xl:text-[70px]" : "xl:text-[64px]"} uppercase text-[8.533vw] 2xl:text-[5.208vw]   2xl:pt-[1.3vw] xl:pt-[1.3vw] text-center xl:text-left leading-[94%] lg:leading-[81%] tracking-[-0.07em] w-2/3 pt-[6px]`}>
