  ...
  return (
    <div className={`  lg:border-r border-b-0  border-[#c7c7c7] flex flex-col items-center  lg:items-start pb-[30px] lg:pb-0 lg:border-b`}>
      <div className={`2xl:ps-[2.604vw] xl:ps-[2.7vw]  flex flex-col items-center lg:items-start `}>
        <h2 className={`2xl:ps-[0.36vw] xl:ps-[0.36vw] font-semibold lg:font-medium ${isSpecialWidth ? "xl:text-[20px]" : "xl:text-[18px]"} text-[#8C331B] xl:mt-[1.25vw] 2xl:mt-[2.29vw] 2xl:text-[1.25vw] xl:text-[0.938vw] font-cofo-medium text-[3.2vw] text-center xl:text-left mt-6 uppercase tracking-[-0.05em]`}>
