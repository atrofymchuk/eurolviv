...
export const suggestion = [
  {
    ...
    desc: [
      "home.roofService.restaurant.desc.0",
      "home.roofService.restaurant.desc.1",
      "home.roofService.restaurant.desc.2",
      "home.roofService.restaurant.desc.3",
    ],
    url: "/restaurant",
  },
  {
    ...
    desc: [
      "home.roofService.karaoke.desc.0",
      "home.roofService.karaoke.desc.1",
      "home.roofService.karaoke.desc.2",
      "home.roofService.karaoke.desc.3",
    ],
  ...
  },
  {
    ...
    desc: [
      "home.roofService.terrace.desc.0",
      "home.roofService.terrace.desc.1",
      "home.roofService.terrace.desc.2",
    ],
    url: "/terrace",
  },
];
...
export const places = [
  ["about.whereWeAre.places.title.0", "about.whereWeAre.places.title.1"],
  ["about.whereWeAre.places.title2.0", "about.whereWeAre.places.title2.1"],
  ["about.whereWeAre.places.title3.0", "about.whereWeAre.places.title3.1"],
  ["about.whereWeAre.places.title4.0", "about.whereWeAre.places.title4.1"],
  ["about.whereWeAre.places.title5.0", "about.whereWeAre.places.title5.1"],
  ["about.whereWeAre.places.title6.0", "about.whereWeAre.places.title6.1"],
  ["about.whereWeAre.places.title7.0", "about.whereWeAre.places.title7.1"],
  ["about.whereWeAre.places.title8.0", "about.whereWeAre.places.title8.1"],
];
  ...
  ua: [
    {
      ...
      textEn:
        "Comfortable, bright rooms with a perfect location—just a 10-minute walk to the city center. The restaurant on the 8th floor is fantastic, with delicious breakfasts and a stunning view.",
    },
    {
      id: 2,
      name: "Tetiana",
      ...
      textEn:
        "Great location, clean rooms, and delicious breakfasts with a wide variety of options for both adults and kids. It's also great to have an open terrace where you can enjoy a tasty dinner late into the night.",
    },
  ],
  abroad: [
    {
...
export const concepts = [
  ...
  },
  {
    ...
    alt: "conference",
    text: [
      "about.concepts.thirdCard.desc.0",
      "about.concepts.thirdCard.desc.1",
      "about.concepts.thirdCard.desc.2",
      "about.concepts.thirdCard.desc.3",
    ],
  },
  {
    title: [
    ...
    img: bar,
    to: "/restaurant#karaoke",
    alt: "karaoke",
    text: [
      "about.concepts.fourthCard.desc.0",
      "about.concepts.fourthCard.desc.1",
      "about.concepts.fourthCard.desc.2",
    ],
  },
];
