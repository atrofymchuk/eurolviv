...
> = {
  uk: {
    ...
    "travel-with-pet": {
      title: "Готель у Львові з домашніми тваринами – Eurohotel",
      description:
        "Pet friendly пропозиція в готелі Eurohotel у Львові. Умови проживання з домашніми улюбленцями.",
    ...
    "newly-weeds": {
      title: "Подарунок для молодят у готелі Eurohotel Львів",
      description:
        "Спеціальна пропозиція для молодят у готелі Eurohotel у Львові. Безкоштовне проживання, компліменти та пізнє виселення.",
